...
export async function renderHome(root) {
  root.innerHTML = `<div class="shell"><header class="topbar"><a class="logo" href="/" data-link>ARENA</a><div class="actions"><button class="btn ghost" data-import-json>⬆ Importar .json</button><button class="btn ghost" data-planos>${icon('creditCard', 16)} Planos</button><button class="btn ghost" data-tutorial>Tutorial</button><button class="btn ghost" data-logout>Sair</button></div></header><main class="section"><div class="actions" style="justify-content:space-between"><div><small>PAINEL DO ORGANIZADOR</small><h1>Meus campeonatos</h1></div><button class="btn primary" data-new>+ Criar campeonato</button></div><div data-list class="grid" style="margin-top:24px"><div class="card">Carregando campeonatos...</div></div></main></div>`;
